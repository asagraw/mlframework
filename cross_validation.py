...
class CrossValidation:
    def __init__(self,df,target_cols,shuffle,
...
if __name__ == "__main__":
    df = pd.read_csv(r"C:\Deep Learning CourseEra Course\kaggle\cat_enc_challange\input\train_imet.csv")

    # cv = CrossValidation(df,target_cols=['SalePrice'],shuffle=False, problem_type='single_col_regression')
